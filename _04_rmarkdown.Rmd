...
## Transform you `r gh()` repo into a website
...
`r tr()` exported html must be names `index.html`
...
- See [documentation page](https://docs.github.com/en/pages) for mucu more info 
